...
<div id='login'>
	<form action='manEmp.php' method='get'>
		ID <input name='id' type='input'>
		Name <input name='name' type='input'>
		Last Name <input name='lastname' type='input'>  
				...
				if ($rows)
				{
					echo "<table>";
						...
						foreach ($rows as $aa) 
						{
							...
							echo "<td><a href='manEmpFunc.php?id=$Eid'><button class='buttonA' type='button'>Manage</button></a></td>";
							echo "</tr>";
						}
					echo "</table><br><br>";
				}
