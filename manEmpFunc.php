...
?>
	...
	<div>
		<a href= 'manEmpFunction.php?function=asswork&id=<?php echo $id;?>'><button class="buttonC" type="button">Assign work</button></a>
		<a href= 'manEmpFunction.php?function=salary&id=<?php echo $id;?>'><button class="buttonC" type="button">Manage salary</button></a>
		<a href= 'manEmpFunction.php?function=promote&id=<?php echo $lookforID;?>'><button class="buttonC" type="button" onClick="return confirm('are you sure you want to promote to be a manager??')">Promote</button></a><br>
		<a href= 'manEmpFunction.php?function=changedept&id=<?php echo $lookforID;?>'><button class="buttonB" type="button">Change department</button></a>
		<a href= 'manEmpFunction.php?function=fire&id=<?php echo $id;?>'><button class="buttonB" type="button" onClick="return confirm('are you sure you want to delete??')">Delete</button></a>
